...
public getProductsFromServer(){
   return this.httpClient
    ...
    .pipe(
    map(
      data => {alert("from getProductsFromServer"); this.Products=data;console.log(this.Products); return data;},
      error =>{}
  )); 
  }
  private getCategoriesFromServer(){
     return this.httpClient
      ...
      .pipe(
      map(
        data => { alert("from getCategoriesFromServer");this.Categories=data;console.log(this.Categories);return data;},
        error =>{}
    ));
   }
   //
